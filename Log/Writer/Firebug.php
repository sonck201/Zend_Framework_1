...
class Zend_Log_Writer_Firebug extends Zend_Log_Writer_Abstract
{
     ...
     *
     * @param bool $enabled Set to TRUE to enable the log writer
     *
     ...
     *
     * @return bool Returns TRUE if the log writer is enabled.
     */
     ...
     *
     * @return string|bool The previous logging display style if defined or TRUE otherwise
     */
     ...
     * @param int $priority The logging priority
     *
     * @return string|bool The logging display style if defined or FALSE otherwise
     */
