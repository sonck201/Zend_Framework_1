...
class Zend_Gdata_Gapps_Extension_Login extends Zend_Gdata_Extension
{
     ...
     * @param bool $admin (optional) Whether the user is an administrator
     *                    or not.
     * @param bool $suspended (optional) Whether this login is suspended or not.
     * @param bool $changePasswordAtNextLogin (optional) Whether
     *                                        the user is required to change their password at their
     *                                        next login.
     * @param bool $agreedToTerms (optional) Whether the user has
