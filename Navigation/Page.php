...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
    ...
    public function setCustomHtmlAttrib($name, $value)
    {
        if (!is_string($name)) {
            require_once 'Zend/Navigation/Exception.php';
            throw new Zend_Navigation_Exception('Invalid argument: $name must be a string');
        }

        if (null !== $value && !is_string($value)) {
            require_once 'Zend/Navigation/Exception.php';
            throw new Zend_Navigation_Exception('Invalid argument: $value must be a string or null');
        }
