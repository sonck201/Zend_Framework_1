...
class Zend_Service_Amazon_Ec2_Instance extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     * @param bool                       Ture to ignore Terminated Instances.
     * @param mixed|null $instanceId
     * @param mixed $ignoreTerminated
     *
     * @return array
     */
     ...
     *
     * @return array|bool An array if the product code is attached to the instance, false if it is not.
     */
