...
class Zend_Service_WindowsAzure_CommandLine_Deployment extends Zend_Service_Console_Command
{
     ...
     * @param mixed $deploymentName
     * @param mixed $label
     * @param mixed $staging
     * @param mixed $production
     * @param mixed $packageUrl
     * @param mixed $serviceConfigurationLocation
     * @param mixed $startImmediately
     * @param mixed $warningsAsErrors
     ...
     * @param mixed $staging
     * @param mixed $production
     * @param mixed $packageLocation
     * @param mixed $serviceConfigurationLocation
     * @param mixed $storageAccount
     * @param mixed $startImmediately
     * @param mixed $warningsAsErrors
     * @param mixed $waitForOperation
     */
