...
class Zend_Service_WindowsAzure_Management_Client
{
     ...
     * @param bool $startDeployment Indicates whether to start the deployment immediately after it is created.
     * @param bool $treatWarningsAsErrors Indicates whether to treat package validation warnings as errors.
     *
     * @throws Zend_Service_WindowsAzure_Management_Exception
     */
